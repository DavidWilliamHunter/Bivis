function [ results, fvals, statii, reconPatches ] = gaborFitPatches(patches, width, height, popSize, generations)    
    ...
    parfor i=1:size(patches,1)
        ...
        leftRec = gabor2d(leftGabor);
        rightRec = gabor2d(rightGabor);
